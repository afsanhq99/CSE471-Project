<div class="sidebar-menu">
    ...
    <div class="menu">
        <ul id="menu">
            ...
            <li id="menu-academico"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Hotel
                        Packages</span> <span class="fa fa-angle-right" style="float: right"></span>
                    <div class="clearfix"></div>
                </a>
                <ul id="menu-academico-sub">
                    <li id="menu-academico-avaliacoes"><a href="create-hotel.php">Create</a></li>
                    <li id="menu-academico-avaliacoes"><a href="manage-hotel.php">Manage</a></li>
                </ul>
            </li>
            ...
            <li id="menu-academico"><a href="managehotel-users.php"><i class="fa fa-users"
                        aria-hidden="true"></i><span>Manage Hotel Users</span>
                    <div class="clearfix"></div>
                </a></li>

            <li><a href="manage-bookings.php"><i class="fa fa-list" aria-hidden="true"></i> <span>Manage Tour
                        Booking</span>
                    <div class="clearfix"></div>
                </a></li>
            <li><a href="managehotel-bookings.php"><i class="fa fa-list" aria-hidden="true"></i> <span>Manage Hotel
                        Booking</span>
                    <div class="clearfix"></div>
                </a></li>


            <li><a href="manageissues.php"><i class="fa fa-table"></i> <span>Manage Tour Issues</span>
                    <div class="clearfix"></div>
                </a></li>
            <li><a href="managehotelissues.php"><i class="fa fa-table"></i> <span>Manage Hotel Issues</span>
                    <div class="clearfix"></div>
                </a></li>
            ...
            <li><a href="managehotel-enquires.php"><i class="fa fa-file-text-o" aria-hidden="true"></i> <span>Manage
                        Hotel Enquiries</span>
                    <div class="clearfix"></div>
                </a></li>
