...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO hoteltourhotels(HotelName,HotelType,HotelLocation,HotelPrice,HotelFetures,HotelDetails,HotelImage) VALUES(:pname,:ptype,:plocation,:pprice,:pfeatures,:pdetails,:pimage)";
        ...
        if ($lastInsertId) {
            ...
            $error = "Not Hotel Created Successfully";
        }
    }
...
<head>
    <title>Triumph Tourism | Admin Hotel Creation</title>
...
<body>
    <div class="page-container">
        ...
        <div class="left-content">
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Create Hotel
                </li>
            </ol>
            <!--grid-->
            <div class="grid-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="hotelname" id="Hotelname"
                                            placeholder="Create Hotel" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="hoteltype" id="Hoteltype"
                                            placeholder=" Hotel Type eg- Family Hotel / Couple Hotel" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="hotellocation" id="Hotellocation"
                                            placeholder=" Hotel Location" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="hotelprice" id="Hotelprice"
                                            placeholder=" Hotel Price is TK" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="hotelfeatures" id="Hotelfeatures"
                                            placeholder="Hotel Features Eg-free Pickup-drop facility" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" rows="5" cols="50" name="hoteldetails"
                                            id="Hoteldetails" placeholder="Hotel Details" required></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
