...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_REQUEST['eid'])) {
        ...
        $sql = "UPDATE hotelenquiry SET Status=:status WHERE  id=:eid";
                    ...
                    <div class="agile-tables">
                        <div class="w3l-table-info">
                            ...
                            <table id="table">
                                ...
                                <tbody>
                                    <?php $sql = "SELECT hotelissues.id as id,hotelusers.FullName as fname,hotelusers.MobileNumber as mnumber,hotelusers.EmailId as email,hotelissues.Issue as issue,hotelissues.Description as Description,hotelissues.PostingDate as PostingDate from hotelissues join hotelusers on hotelusers.EmailId=hotelissues.UserEmail";
                                    $query = $dbh->prepare($sql);
                                    $query->execute();
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {                ?>
                                            <tr>
                                                ...
                                                <td><a href="javascript:void(0);" onClick="popUpWindow('updateissue.php?iid=<?php echo ($result->id); ?>');">View
                                                    </a>
                                                </td>
