...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        move_uploaded_file($_FILES["hotelimage"]["tmp_name"], "pacakgeimages/" . $_FILES["hotelimage"]["name"]);
        $sql = "update HotelTourHotels set HotelImage=:pimage where HotelId=:imgid";
...
<body>
    <div class="page-container">
        ...
        <div class="left-content">
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Update Hotel
                    Image </li>
            </ol>
            <!--grid-->
            <div class="grid-form">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="horizontal-form">
                            <form class="form-horizontal" name="hotel" method="post" enctype="multipart/form-data">
                                <?php
                                    $imgid = intval($_GET['imgid']);
                                    $sql = "SELECT HotelImage from HotelTourHotels where HotelId=:imgid";
                                    $query = $dbh->prepare($sql);
                                    $query->bindParam(':imgid', $imgid, PDO::PARAM_STR);
                                    $query->execute();
