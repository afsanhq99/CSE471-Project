...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "update hotelTourHotels set HotelName=:pname,HotelType=:ptype,HotelLocation=:plocation,HotelPrice=:pprice,HotelFetures=:pfeatures,HotelDetails=:pdetails where HotelId=:pid";
                ...
                <div class="grid-form1">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="horizontal-form">
                            ...
                            <?php
                                $pid = intval($_GET['pid']);
                                $sql = "SELECT * from hotelTourHotels where HotelId=:pid";
                                $query = $dbh->prepare($sql);
                                $query->bindParam(':pid', $pid, PDO::PARAM_STR);
                                $query->execute();
                            ...
                            <form class="form-horizontal" name="Hotel" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="Hotelname" id="Hotelname"
                                            placeholder="Create Hotel"
                                            value="<?php echo htmlentities($result->HotelName); ?>" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Hotel Type</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="Hoteltype" id="Hoteltype"
                                            placeholder=" Hotel Type eg- Family Hotel / Couple Hotel"
                                            value="<?php echo htmlentities($result->HotelType); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="Hotellocation" id="Hotellocation"
                                            placeholder=" Hotel Location"
                                            value="<?php echo htmlentities($result->HotelLocation); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="Hotelfeatures" id="Hotelfeatures"
                                            placeholder="Hotel Features Eg-free Pickup-drop facility"
                                            value="<?php echo htmlentities($result->HotelFetures); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" rows="5" cols="50" name="Hoteldetails"
                                            id="Hoteldetails" placeholder="Hotel Details"
                                            required><?php echo htmlentities($result->HotelDetails); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
