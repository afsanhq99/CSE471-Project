        ...
        <div class="holiday">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <form action="search.php" class="form-inline md-form mr-auto mb-4">
                        <input class="form-control mr-sm-2" name='searched_price1' types="text" placeholder="Price" aria-label="Search">
                        <button class="btn btn-outline-warning mt-2  btn-rounded btn-sm my-0" type="submit">Price1</button>

                        <input class="form-control mr-sm-2" name='searched_price2' types="text" placeholder="Price" aria-label="Search">
                        <button class="btn btn-outline-warning mt-2  btn-rounded btn-sm my-0" type="submit">Price2</button>
                    </form>
                    ...
                    <form action="search.php" class="form-inline md-form mr-auto mb-4">
                        ...
                        <button class="btn btn-outline-warning mt-2  btn-rounded btn-sm my-0" type="submit">Location</button>
                    </form>
                    <br></br>
