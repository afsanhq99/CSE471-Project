...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO  tblusers(FullName,MobileNumber,EmailId,Password) VALUES(:fname,:mnumber,:email,:password);INSERT INTO  hotelusers(FullName,MobileNumber,EmailId,Password) VALUES(:fname,:mnumber,:email,:password)";
                        ...
                        <div class="login">
                            ...
                            <div class="login-right">
                                <form name="signup" method="post">
                                    ...
                                    <input type="text" style="color:black" value="" placeholder="Email id" name="email"
