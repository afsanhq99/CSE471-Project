<!--- /footer-top ---->
<!---copy-right ---->
<div class="copy-right" style="background-color:#253a1c" style="width: 100%;>
    ...
    <p class="wow zoomIn animated animated" data-wow-delay=".5s"
        style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">© 2020 TMS . All Rights Reserved
    </p>
</div>
</div>