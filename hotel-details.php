                ...
                foreach ($results as $result) {    ?>
                    ...
                    <form name="book" method="post">
                        ...
                        <div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
                            ...
                            <p class="dow">#PKG-<?php echo htmlentities($result->HotelId); ?></p>
                            <p><b>Hotel Type :</b> <?php echo htmlentities($result->HotelType); ?></p>
                        ...
                        <h3>Hotel Details</h3>
                        <p style="padding-top: 1%"><?php echo htmlentities($result->HotelDetails); ?> </p>
                        <div class="clearfix"></div>
        </div>
